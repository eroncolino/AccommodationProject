...
<div class="filters">
    <form id="filters-form" action="" onsubmit="setFilterSearch()">
            ...
            <div class="type-filter">
                <div class="type">
                    ...
                    <select class="form-control" name="house-type" form="filters-form">
                        ...
                        <option value="multiple">Multiple-bedroom apartment</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="search-filter">
            <button class="search-button" type="submit"><i class="material-icons search-icon">search</i><span>Search</span>
            </button>
        </div>
